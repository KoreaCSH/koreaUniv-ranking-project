...
public interface EducationHallTop3Repository extends JpaRepository<EducationHallTop3, Long> {

    @Query("SELECT e FROM EducationHallTop3 e ORDER BY e.studyDate DESC, e.ranking")
