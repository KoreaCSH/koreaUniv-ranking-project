package koreaUniv.koreaUnivRankSys.batch.common;
...
public class JobLoggerListener implements JobExecutionListener {
    ...
    private static String FAILED_MESSAGE = "{} Job is Failed";
    ...
    public void afterJob(JobExecution jobExecution) {
        ...
        if(jobExecution.getStatus() == BatchStatus.FAILED) {
            // email 로도 보내줄 수 있다.
            log.error(FAILED_MESSAGE, jobExecution.getJobInstance().getJobName());
        }
    }
}
